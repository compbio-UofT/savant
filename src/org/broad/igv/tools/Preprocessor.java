...
public class Preprocessor implements DataConsumer {
     ...
     */
    public void addData(String chr, int start, int end, float[] data, String name) throws PreprocessingException {
     ...
     */
    public void newChromosome(String chr) throws PreprocessingException {
	...
	public void addData(int start, int end, float[] data) throws PreprocessingException {
	...
	void close() throws PreprocessingException {
		...
		try {
		    ...
		    throw new PreprocessingException("Error writing tile", iOException);
		}
	    }
	}
    }
    ...
    public void preprocess(File iFile, int maxZoomValue) throws IOException, PreprocessingException {
