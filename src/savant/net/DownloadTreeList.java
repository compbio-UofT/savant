...
public class DownloadTreeList extends JDialog {
    ...
    public DownloadTreeList(
        ...
        downbutt.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                DownloadTreeRow r  = (DownloadTreeRow) table.getRowAt(table.getSelectedRow());
                if (r != null && r.isLeaf()) {
    ...
    public final Component getCenterPanel(List<DownloadTreeRow> roots) {
        table = new TreeTable(new DownloadTreeListTableModel(roots));
