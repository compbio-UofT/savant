...
public class IntervalRecordGetter {
    ...
    public static List<IntervalRecord> getData(SavantFile dFile, Range r, IntervalTreeNode n) throws IOException {
    ...
    private static void getData(SavantFile dFile, List<IntervalRecord> data, Range r, IntervalTreeNode n) throws IOException {
    ...
    private static List<IntervalRecord> getIntersectingIntervals(SavantFile dFile, Range r, IntervalTreeNode n) throws IOException {
        ...
        if (n.size > 0) {
            ...
            for (int i = 0; i < n.size; i++) {
                ...
                IntervalRecord ir = DataFormatUtils.convertRecordToInterval(record, dFile.getFileType(), dFile.getFields());
    ...
    public static List<IntervalRecord> getRecordsInBin(SavantFile dFile, IntervalTreeNode n) throws IOException {
