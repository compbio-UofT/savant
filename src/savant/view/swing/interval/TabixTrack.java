 ...
 * @author mfiume
 */
public class TabixTrack extends Track {

    private static Log LOG = LogFactory.getLog(TabixTrack.class);

    public enum DrawingMode { SQUISH, PACK, ARC };

    public TabixTrack(DataSource intervalTrack) throws SavantTrackCreationCancelledException {
