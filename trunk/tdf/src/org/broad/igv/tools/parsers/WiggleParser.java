...
public class WiggleParser {
     ...
     *
     */
    public WiggleParser(String file, DataConsumer dataConsumer, Genome genome) throws IOException {
     ...
     *
     */
    public WiggleParser(ResourceLocator locator, DataConsumer dataConsumer, Genome genome) throws IOException {
