...
public class SavantUnsupportedFileTypeException extends IOException {
    ...
    public SavantUnsupportedFileTypeException(String msg) {
        super(msg);
    }

    public SavantUnsupportedFileTypeException(String msg, Throwable t) {
        super(msg, t);
    }

    public SavantUnsupportedFileTypeException(Throwable t) {
        super(t);
    }
}
