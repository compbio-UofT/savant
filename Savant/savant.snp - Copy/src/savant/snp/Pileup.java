...
class Pileup {
    ...
    private final String viewTrackName;
    ...
    public Pileup(String viewTrackName, long position, Nucleotide n, double baseline_rate) {
        this.viewTrackName = viewTrackName;
        this.position = position;
        this.referenceNucleotide = n;
    ...
    public Pileup(String viewTrackName, long position, Nucleotide n, double baseline_rate, int pseudoCount) {
        this.viewTrackName = viewTrackName;
        this.position = position;
        this.referenceNucleotide = n;
        this.baseline_rate = baseline_rate;
