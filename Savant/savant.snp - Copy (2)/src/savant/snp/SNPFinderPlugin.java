...
public class SNPFinderPlugin extends SavantPanelPlugin
    ...
    private void setupGUI(JPanel panel) {
        ...
        JPanel settingsPanel = new JPanel(); settingsPanel.setLayout(new BorderLayout());
        JPanel outputPanel = new JPanel(); outputPanel.setLayout(new BorderLayout());
        ...
        JCheckBox cb_on = new JCheckBox("On/Off");
        ...
        JCheckBox cb_bm = new JCheckBox("Add Bookmarks");
        ...
        settingsPanel.add(tb, BorderLayout.NORTH);
        ...
        tp.addTab("Settings2", new SettingsPanel());
        tp.addTab("Output", outputPanel);
    ...
    private boolean foundSNPAlready(TrackAdapter t, Pileup p) {
        ...
        if (snpsFound == null) {
            System.err.println("Snp list is null!");
            return false;
        }
        if (p == null) {
        ...
        if (p != null && snpsFound.containsKey(t) && snpsFound.get(t).contains(p)) {
