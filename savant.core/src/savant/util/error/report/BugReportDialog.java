...
public class BugReportDialog extends javax.swing.JDialog {
    ...
    private String toolName = "Savant";
    private String toolVersion = BrowserSettings.VERSION;
    ...
    public BugReportDialog(java.awt.Frame parent, Exception e) {
        this(parent, null, e);
    }

    public BugReportDialog(java.awt.Frame parent, String description, Exception e) {
        super(parent, true);
        initComponents();
        if (description != null) {
